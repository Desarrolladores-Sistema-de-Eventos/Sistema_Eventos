            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="ui.html"><i class="fa fa-calendar fa-3x"></i>Eventos</a>
                    </li>
                    <li>
                        <a  href="tab-panel.html"><i class="fa fa-users fa-3x"></i> Participantes</a>
                    </li>
						   <li  >
                        <a   href="chart.html"><i class="fa fa-file-text fa-3x"></i>Inscripciones</a>
                    </li>	
                      <li  >
                        <a  href="table.html"><i class="fa fa-bar-chart-o fa-3x"></i>Reportes</a>
                    </li>
                    <li  >
