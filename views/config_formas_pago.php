...
<style>
    ...
    .table-responsive {
        ...
        /* max-height: 600px;  Eliminado, no es necesario para esta tabla */
        overflow-y: auto; /* Mantener overflow para scroll si es necesario */
    }

    #tablaFormasPago thead th {
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="mb-4">
            <h3 class="uta-title"><i class="fa fa-credit-card me-2"></i> Gestión de Formas de Pago</h3>
            <p class="descripcion-seccion">Administra las formas de pago disponibles en el sistema.</p>
        </div>

        <div class="d-flex justify-content-between align-items-center mb-3">
            <button class="btn btn-success shadow-sm" id="btnAgregarFormaPago">
                <i class="fa fa-plus me-1"></i> Agregar Forma de Pago
            </button>
        ...
        <div class="modal-content shadow-sm">
            <form id="formFormaPago">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="codigoFormaPago" class="form-label">Código</label>
