...
<div id="page-wrapper">
  <div id="page-inner">
    <h2 class=""><i class="fa fa-credit-card"></i> Gestión de Formas de Pago</h2>

    <div class="mb-3">
      <button class="btn btn-carrusel-upload" id="btnAgregarFormaPago"><i class="fa fa-plus"></i> Agregar Forma de Pago</button>
    </div>
    <br>
    ...
    <div class="modal-content">
      <form id="formFormaPago">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-carrusel-upload" id="btnGuardarFormaPago">
