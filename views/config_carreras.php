...
<div id="page-wrapper">
  <div id="page-inner">
    <h2 class=""><i class="fa fa-graduation-cap"></i> Gestión de Carreras</h2>
    <div class="mb-3">
      <button class="btn" id="btnAgregarCarrera" style="background-color: #e0e0e0; color: #111; border: none;">
    ...
    <div class="modal-content">
      <form id="formCarrera">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn" id="btnGuardarCarrera" style="background-color: #e0e0e0; color: #111; border: none;">
