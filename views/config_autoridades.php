...
<div id="page-wrapper">
  <div id="page-inner">
    <h2 class=""><i class="fa fa-user"></i> Gestión de Autoridades</h2>
    <div class="mb-3">
      <button class="btn" id="btnAgregarAutoridad" style="background-color: #e0e0e0; color: #111; border: none;">
        <i class="fa fa-plus"></i> Agregar Autoridad
      </button>
    </div>
    <br>
    <div class="table-responsive">
      <table class="table table-dark table-bordered table-hover" id="tabla-autoridades">
        <thead>
          <tr>
            <th>Foto</th>
            <th>Nombres</th>
        ...
        <tbody>
          <!-- Aquí se cargan las autoridades dinámicamente -->
        </tbody>
      </table>
    </div>
    <div>
      ...
      <form id="formAutoridad" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="facultadAutoridad">Facultad</label>
            <select class="form-control" id="facultadAutoridad" name="facultad_secuencial" required>
              <option value="">Cargando facultades...</option>
            </select>
          </div>
          <input type="hidden" id="autoridadId" name="id">
          <div class="form-group">
            <label for="nombresAutoridad">Nombres</label>
            <input type="text" class="form-control" id="nombresAutoridad" name="nombres" required>
          </div>
          <div class="form-group">
            <label for="cargoAutoridad">Cargo</label>
            <input type="text" class="form-control" id="cargoAutoridad" name="cargo" required>
          </div>
          <div class="form-group">
            <label for="correoAutoridad">Correo</label>
            <input type="email" class="form-control" id="correoAutoridad" name="correo" required>
          </div>
          <div class="form-group">
            <label for="telefonoAutoridad">Teléfono</label>
            <input type="text" class="form-control" id="telefonoAutoridad" name="telefono" maxlength="20" placeholder="Ingrese el teléfono">
          </div>
          <div class="form-group">
            <label for="fotoAutoridad">Foto de Perfil</label>
            <input type="file" class="form-control" id="fotoAutoridad" name="foto_url" accept="image/*">
            <small id="labelFotoNombre" class="form-text text-muted"></small>
          </div>
        </div>
        <div class="modal-footer">
          ...
          <button type="submit" class="btn" id="btnGuardarAutoridad" style="background-color: #e0e0e0; color: #111; border: none;">
...
<script src="../public/js/facultades_select.js"></script>
