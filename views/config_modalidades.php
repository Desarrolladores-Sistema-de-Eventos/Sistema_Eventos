...
<div id="page-wrapper">
  <div id="page-inner">
    <h2 class=""><i class="fa fa-random"></i> Gestión de Modalidades de Evento</h2>

    <div class="mb-3">
      <button class="btn" id="btnAgregarModalidad" style="background-color: #e0e0e0; color: #111; border: none;">
    ...
    <div class="modal-content">
      <form id="formModalidad">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn" id="btnGuardarModalidad" style="background-color: #e0e0e0; color: #111; border: none;">
